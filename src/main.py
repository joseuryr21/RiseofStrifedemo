...
import pygame
from view.renderGame import renderGame, tileSprites, tileHoverPositions, checkHoverStatus
    ...
    while optionSelecting and isRunning:
        if cntTurnNum % 2 == 0: #player
            ...
            if characterDecisions[0] == False:
                ...
                for i in range(0, 26):
                    isHovered = checkHoverStatus(mousePosition, tileSprites, tileHoverPositions[i][0], tileHoverPositions[i][1], tileHoverPositions[i][2], tileHoverPositions[i][3])
